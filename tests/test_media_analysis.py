    ...
    def test_media_analysis_defaults_turn_on_host_chat_paths_vision(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertEqual(applied["transcription"], {"enabled": True, "allow_model_download": False})
                ...
                self.assertEqual(transcription_on["transcription"], {"enabled": True, "allow_model_download": False})
